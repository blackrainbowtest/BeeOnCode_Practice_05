    ...
    <MainContainer>
      ...
      <TableContainer>
        ...
        >
          <TableHead>
            <TableRow>
              <TableCell align='center'>Color and prob</TableCell>
              <TableCell align='center'>St. weight</TableCell>
          ...
          <TableBody>
            {golds.map((row, index) => (
              ...
              >
                ...
                <TableCell align='center'>{row.startWeight}</TableCell>
...
export default memo(WatchGoldComponent);
